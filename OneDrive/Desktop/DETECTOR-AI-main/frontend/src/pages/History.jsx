    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 20px 80px" }}>
      ...
      {error && (
        <div style={{
          ...
          <RealisticFigure symbol="⚠️" className="animated-emoji emoji-status" /> {error} — <button onClick={load} style={{ background: "none", border: "none", color: "var(--accent)", cursor: "pointer" }}>Retry</button>
        </div>
      )}
          ...
          {data.scans.length === 0 ? (
            <Card>
              <div style={{ textAlign: "center", padding: "60px 20px", color: "var(--muted)" }}>
                <div style={{ fontSize: 48, marginBottom: 16 }}><RealisticFigure symbol="📭" className="animated-emoji emoji-icon" size={48} /></div>
                  ...
                  {data.scans.map((scan, i) => (
                    ...
                    >
                      ...
                      <div style={{ flexShrink: 0, display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        >
                          <RealisticFigure symbol={deleting === scan.id ? "…" : "🗑"} className="animated-emoji emoji-action" />
                        </button>
                      </div>
                    </div>
                  ))}
